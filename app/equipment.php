<?php
    ...
    $sqlQuery="SELECT * FROM services where categorie='Equipement'";
  ...
  <section class="wrapper" style="margin-left: 16%; margin-top: -11%;">
   ...
   <a type="button" data-toggle="modal" data-target="#exampleModalScrollable" style="cursor:pointer;">
                        ...
                        <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document"> 
                            <div class="modal-content"> 
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalScrollableTitle"><i class="fa fa-dog"></i>Category : Dogs</h5> 
                                ...
                                <div class="modal-body pr-4 pl-4">
                                    <div id="pop" class="row">
                                        <?php
                                        $sql="SELECT * FROM services WHERE categorie='Equipement' AND target_species='Dog'";
            ...
            <div class="card bg-dark mb-3 text-light">
                ...
                <?php
echo '<h5 style="font-size: 18px; font-weight: bold; margin-bottom: 10px;">' . strtoupper($value['name']) . '</h5>';
echo '<span style="font-size: 20px; color: red; text-align: center;">' . $value['price'] . ' DT </span>';
?>
                        ...
                        <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document"> 
                            <div class="modal-content"> 
                                ...
                                <div class="modal-body pr-4 pl-4">
                                    <div id="pop" class="row">
                                        <?php
                                        $sql="SELECT * FROM services WHERE categorie='Equipement' AND target_species='Cat'";
                                        $stmt=$connect->query($sql);
                                        $stmt->execute();
                                        while ($value=$stmt->fetch()) {
                        ...
                        <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document"> 
                            <div class="modal-content"> 
                                ...
                                <div class="modal-body pr-4 pl-4">
                                    <div id="pop" class="row">
                                        <?php
                                        $sql="SELECT * FROM services WHERE categorie='Equipement' AND target_species='Rabbit'";
                                        $stmt=$connect->query($sql);
                                        $stmt->execute();
                                        while ($value=$stmt->fetch()) {
                        ...
                        <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document"> 
                            <div class="modal-content"> 
                                ...
                                <div class="modal-body pr-4 pl-4">
                                    <div id="pop" class="row">
                                        <?php
                                        $sql="SELECT * FROM services WHERE categorie='Equipement' AND target_species='Bird'";
                                        $stmt=$connect->query($sql);
                                        $stmt->execute();
                                        while ($value=$stmt->fetch()) {
...
<!--lmfao -->
        ...
        <div class="container-fluid">
            ...
            <div class="card bg-dark mb-3 text-light">
                ...
                <?php
echo '<h5 style="font-size: 18px; font-weight: bold; margin-bottom: 10px;">' . strtoupper($value['name']) . '</h5>';
echo '<span style="font-size: 20px; color: yellow;">' . $value['price'] . ' DT </span>';
?>
           <form method="GET" action="equipment.php?id=<?php echo $id?>#added">
                <input type="submit" value="Add To Cart" name="addcart"><a name="added">
