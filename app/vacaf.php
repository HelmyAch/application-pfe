                        ...
                        <?php 
                            foreach ($data as $key) {
                                echo '<tr>';
                                    ...
                                    echo '<td>'.$key['nom'].'</td>';
                                    echo '<td>'.$key['animalCategorie'].'</td>';
                                    echo '<td>'.$key['date'].'</td>';
                                    echo '<td>'.$key['Location'].'</td>';
                                    echo '<td><a href="delete_vac.php?id='.$key['id'].'" class="btn btn-danger">Delete</a></td>'; // Ajout du bouton Supprimer
                                echo '</tr>';
                            }
                        ?>
