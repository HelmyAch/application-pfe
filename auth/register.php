...
$mdp=md5($password);
			try {
				$sqlQuery="INSERT INTO users (fullname, mobile, username, email,password) VALUES ('$fullname', '$mobile', '$username', '$email', '$mdp')";
				  	...
				  	<form action="" method="post">
					   ...
					   <div class="row">
							  ...
							  <div class="form-group">
							    ...
							    <input type="text" class="form-control" pattern="^(\d{8})$" id="mobile" title="8 digit mobile number" placeholder="8 digit mobile number" name="mobile" required>
							  </div>
							 </div>
							<div class="col-6">					  
							  <div class="form-group">
