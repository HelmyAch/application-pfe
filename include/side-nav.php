          ...
          <ul class="navbar-nav text-center" style="    flex-direction: column;">      
            ...
            <li class="nav-item">
            	<?php if($_SESSION['role'] == 'admin' || $_SESSION['role'] == 'user'){ 
	        		echo '<a href="../app/register.php" class="nav-link">Animal Adoption</a>';
	      	 	} ?>             
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
	        	<a href="../app/listserv.php" class="nav-link">Services</a>
            </li>
            <li class="nav-item">
	        	<a href="../app/feedback.php" class="nav-link">FeedBack</a>
            </li>
          </ul>
        </div>
      </div>
